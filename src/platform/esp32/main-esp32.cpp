...
#define APP_WATCHDOG_SECS 90
    ...
    if (res == ESP_ERR_INVALID_STATE) {
        // With PIOARDUINO_ESP32, this happens... (pre-initialized by IDF?)
        LOG_WARN("ESP Task watchdog was already initialized, reconfiguring.");
    ...
    // was commented out before probably for a reason, so just enable with pioarduino on esp32.
    enableModemSleep();
#endif
